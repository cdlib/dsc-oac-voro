 ...
 *
 * $Id: UtilizationTracker.java,v 1.19.2.5 2008/03/20 03:34:21 mark Exp $
 */
...
public class UtilizationTracker {
    ...
    public TrackedFileSummary getTrackedFile(long fileNum) {
        ...
        return (TrackedFileSummary) files.get(new Long(fileNum));
    }
    ...
    private TrackedFileSummary getFile(long fileNum) {
        ...
        TrackedFileSummary file = (TrackedFileSummary) files.get(fileNumLong);
        if (file == null) {
            /* Assign volatile files field after modifying the new map. */
